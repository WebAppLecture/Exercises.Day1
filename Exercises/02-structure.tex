...
(\htag{em}) Wörtern, kursiven (\htag{i}) Ausdrücken und fett (\htag{strong})
dargestellten Zahlen geschrieben werden. Im zweiten Absatz sollten
Informationen zum Autor (\htag{address}) und zur letzten Erstellungszeit
(\htag{time}) der Seite angezeigt werden.